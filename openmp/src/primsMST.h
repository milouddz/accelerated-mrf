...
void primsGraph(float* im1,int* ordered,int* parents,float* edgemst,int step1,int m2,int n2,int o2){
	...
	thrust::host_vector<int> index_neighbours(num_vertices*num_neighbours);
	thrust::host_vector<float> edgecost(num_vertices*num_neighbours);
	...
	thrust::host_vector<Edge> priority;
	//thrust::device_vector<Edge> d_priority;
